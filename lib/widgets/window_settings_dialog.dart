...
/// Opens the per-window settings dialog (font scale + title color).
///
/// Changes are applied live via [onChanged] as the user drags the slider or
/// taps a color.
Future<void> showWindowSettingsDialog(
  BuildContext context, {
  required double initialFontScale,
  required Color initialTitleColor,
  required void Function(double fontScale, Color titleColor) onChanged,
}) {
...
class _WindowSettingsDialog extends StatefulWidget {
  ...
  final void Function(double fontScale, Color titleColor) onChanged;
...
class _WindowSettingsDialogState extends State<_WindowSettingsDialog> {
  ...
  void _emit() => widget.onChanged(_fontScale, _titleColor);
